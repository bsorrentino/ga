...
/*
Ga has a suite of easy-to-use and versatile tweening
...
function setup() {
  ...
  tiger1.putRight(text2, 32);
  hedgehog1.addChild(text3);
  hedgehog1.putBottom(text3, -8, 16);
  cat2.addChild(text4);
  cat2.putBottom(text4, -16, 16);
  tiger2.addChild(text5);
  tiger2.putBottom(text5, -8, 16);
  hedgehog2.addChild(text6);
  hedgehog2.putBottom(text6, -8, 16);
  ...
  */
  ...
  //catSlide.onComplete = function() {console.log("Cat slide complete")};
  ...
  //hedgehogPulse.onComplete = function() {console.log("Hedgehog fade complete")};
  ...
  */
  ...
  var catBreathe = g.breathe(cat2, 1.2, 1.2, 60, true, 300);
  ...
  */
  ...
  var hedgehogWobble = g.wobble(hedgehog2, 1.2, 1.2);
